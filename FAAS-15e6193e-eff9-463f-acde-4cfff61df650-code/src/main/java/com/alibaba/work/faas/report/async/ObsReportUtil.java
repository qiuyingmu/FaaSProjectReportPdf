...
public final class ObsReportUtil {
    ...
    static {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            try {
                ...
                System.err.println("[ObsReportUtil] 关闭 OBS 客户端失败: " + e.getMessage());
            }
        }));
    }
    ...
    public static Map<String, String> upload(byte[] pdfBytes, String reportType, String reportName) {
        ...
        System.out.println("[ObsReportUtil] 上传成功: " + objectName
                + " (" + pdfBytes.length + " bytes)");
        System.out.println("[ObsReportUtil] 预览URL: " + previewUrl);
